    ...
    def build_graph(self, learn_rate, num_inputs, num_outputs):
        ...
        with self.graph.as_default():
            ...
            with tf.name_scope('hidden_layers'):
                weight1 = tf.get_variable(shape=[num_inputs, 256], initializer=tf.contrib.layers.xavier_initializer(),
                                          name='weight1')
                ...
                weight2 = tf.get_variable(shape=[256, 256], initializer=tf.contrib.layers.xavier_initializer(),
                                          name='weight2')
            ...
            self.weight = tf.get_variable(shape=[256, num_outputs], initializer=tf.contrib.layers.xavier_initializer(),
                                          name='weight')
