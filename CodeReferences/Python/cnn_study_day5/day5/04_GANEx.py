...
# 아래의 변수들도 결국 tensor에서 표현하는 layer
G = generator(z)
D_real = descriminator(x)
D_gene = descriminator(x)

#desriminator loss function
# 진짜를 진짜라고 할 확률 + 가짜를 아니라고 할 확률
...
#학습시킬 때, D와 G를 따로 학습시켜야 함
#tensorflow의 optimizer는 모든 variable을 학습시키기 때문
